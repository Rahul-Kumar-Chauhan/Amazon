...
WebUI.setText(findTestObject('Object Repository/Amazon_Login_OR/Page_Amazon Sign-In/input_Email or mobile phone number_email'), 
    'rahul883865@gmail.com')

WebUI.click(findTestObject('Object Repository/Amazon_Login_OR/Page_Amazon Sign-In/input_Wrong or Invalid email address or mob_77ed40'))
